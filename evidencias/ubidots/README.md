...
| `correo-recepcion.json` y captura 11 | Recepción observada en el pantallazo original aportado por Natalia; procedencia y huella del archivo |
...
**Recepción verificada:** Natalia aportó la captura original `../pantallazos/11-ubidots-correo-recibido.png`, donde aparecen Notifications Ubidots, Recibidos, la hora 9:08 p. m. y el contenido de la alerta. Coincide con el evento registrado a las 21:08:03. `correo-recepcion.json` documenta la procedencia y SHA256. Se verificó la imagen aportada sin acceder al buzón y se conservó sin editar. El evento queda activo, la temperatura termina en 24 °C y no queda un simulador enviando datos continuamente.
...
La captura 01-resumen.png se conserva como registro histórico de la primera fase, anterior a conectar la cuenta de Ubidots. Su aviso de pendiente ya fue resuelto para recepción de datos, dashboard, envío y recepción del correo. El estado vigente está en la matriz de requisitos y en este informe.
