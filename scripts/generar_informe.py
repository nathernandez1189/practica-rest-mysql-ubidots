...
para('<b>Estado:</b> APIs de memoria y MySQL, desafío JavaScript y persistencia comprobados. Ubidots recibió las cinco variables, el dashboard se actualizó y el evento envió la alerta. La captura aportada por Natalia confirma la recepción del correo. Los requisitos técnicos están completos.','BodyX')
...
para('<b>Recepción confirmada:</b> la captura original aportada por Natalia muestra la alerta en Recibidos a las 9:08 p. m. La hora y el contenido coinciden con el evento registrado. La evidencia se presenta en la página siguiente.')
...
page()
title('Correo recibido: evidencia de cierre',8)
para('Natalia aportó esta captura de la alerta recibida. Se observan el remitente <b>Notifications Ubidots</b>, la etiqueta <b>Recibidos</b>, la hora <b>9:08 p. m.</b> y el contenido referido al dispositivo equipo-rest y al umbral de 30 °C.')
pic('11-ubidots-correo-recibido.png','Figura 8. Captura original aportada por Natalia el 24 de septiembre de 2026. La pantalla marca 9:21 y el mensaje 9:08 p. m.; esta última hora coincide con el registro de envío a las 21:08:03.',width=230)
para('Se verificó la recepción en la imagen compartida; no se accedió directamente al buzón. El archivo se conserva sin editar y la dirección del destinatario no está desplegada. Su procedencia y huella SHA256 están en evidencias/ubidots/correo-recepcion.json.','SmallX')
para('El correo conserva el texto de la primera prueba, anterior a la corrección ortográfica ya documentada. Esta evidencia completa el flujo: muestra simulada, recepción en Ubidots, dashboard, evento y correo recibido.','SmallX')
page()
title('Desafío, reproducción y sustentación',9)
...
pic('06-api-mysql-en-vivo.png','Figura 9. Consulta directa a la API activa en el navegador: libros iniciales y los dos marcadores conservados después del apagado.',width=450)
